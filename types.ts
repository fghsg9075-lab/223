...
export interface SystemSettings {
  ...
  aiLoadingImage?: string; // NEW: Global AI Loading Screen Image
...
export interface LessonContent {
  ...
  videoPlaylist?: {title: string, url: string, price?: number, access?: 'FREE' | 'BASIC' | 'ULTRA'}[]; // NEW: Video Playlist with Access Control
...
export type StudentTab = 'HOME' | 'COURSES' | 'ROUTINE' | 'CHAT' | 'HISTORY' | 'REDEEM' | 'PREMIUM' | 'GAME' | 'WEEKLY_TEST' | 'PROFILE' | 'LEADERBOARD' | 'STORE' | 'VIDEO' | 'PDF' | 'MCQ' | 'ANALYTICS' | 'PRIZES' | 'REWARDS';
